...
struct point {
	int x;
	int y;
} p1 = { 1, 2 }, p2 = { 3, 5 }, p3 = { 1, 2 }, p4 = { 3, 5 }, *pp1 = &p1, *pp2 = &p2, *pp3 = &p3, *pp4 = &p4;
...
int main() {
	...
	isequal = equal(pp1, pp2);

	print_result(isequal, p1, p2);

	isequal = equal(pp1, pp3);

	print_result(isequal, p1, p3);

	isequal = equal(pp4, pp2);

	print_result(isequal, p4, p2);

	isequal = equal(pp3, pp4);
